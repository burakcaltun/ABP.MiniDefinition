...
namespace MiniDefinition.Test.Controllers
{
    public class DepartmentsControllerIntTest
    {
        ...
        public async Task CreateDepartment()
        {
            ...
            testDepartment.Code.Should().Be(DefaultCode);
            testDepartment.Name.Should().Be(DefaultName);
            testDepartment.IsPassive.Should().Be(DefaultIsPassive);
            testDepartment.DatePassive.Should().Be(DefaultDatePassive);
            testDepartment.ApprovalStatus.Should().Be(DefaultApprovalStatus);
            testDepartment.ProcessID.Should().Be(DefaultProcessID);
        }
        ...
        public async Task UpdateDepartment()
        {
            ...
            //TODO detach
            updatedDepartment.Code = UpdatedCode;
            updatedDepartment.Name = UpdatedName;
            updatedDepartment.IsPassive = UpdatedIsPassive;
            updatedDepartment.DatePassive = UpdatedDatePassive;
            updatedDepartment.ApprovalStatus = UpdatedApprovalStatus;
            updatedDepartment.ProcessID = UpdatedProcessID;
            ...
            var testDepartment = departmentList.Last();
            testDepartment.Code.Should().Be(UpdatedCode);
            testDepartment.Name.Should().Be(UpdatedName);
            testDepartment.IsPassive.Should().Be(UpdatedIsPassive);
            testDepartment.DatePassive.Should().BeCloseTo(UpdatedDatePassive, 1.Milliseconds());
            testDepartment.ApprovalStatus.Should().Be(UpdatedApprovalStatus);
            testDepartment.ProcessID.Should().Be(UpdatedProcessID);
        }
